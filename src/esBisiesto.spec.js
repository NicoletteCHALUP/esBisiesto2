...
describe("Es Bisiesto", () => {
    ...
    it("Todos los años divisibles por 4 pero no por 100 SON años bisiestos (por ejemplo, 2008, 2012, 2016), ", () => {
        expect(esBisiesto(2008)).toEqual("SI es bisiesto");
      });
